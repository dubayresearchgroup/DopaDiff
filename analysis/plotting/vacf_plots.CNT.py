...
ax1.set_ylabel("MSD$_\perp$ ($\mathrm{\AA}^2$)", color=cmap(.75))
ax1.set_ylim((0, 10))
ax1.set_xlim((0, 10))
ax2.set_ylabel("MSD$_\parallel$ ($\mathrm{\AA}^2$)", color=cmap(.75))
ax2.set_ylim((0, 10))
ax2.set_xlim((0, 10))
ax3.set_ylabel("MSD$_r$ ($\mathrm{\AA}^2$)", color=cmap(.75))
ax3.set_ylim((0, 0.1))
ax3.set_xlim((0, 10))
...
axright1 = ax1.twinx()
axright1.set_ylabel("$C_\perp$ ($\mathrm{\AA}^2$/ps$^2$)", color='r')
axright1.set_ylim((-.8,2.5))
axright1.set_yticks([0,1,2])
axright2 = ax2.twinx()
axright2.set_ylabel("$C_\parallel$ ($\mathrm{\AA}^2$/ps$^2$)", color='r')
axright2.set_ylim((-.8,2.5))
axright2.set_yticks([0,1,2])
axright3 = ax3.twinx()
axright3.set_ylabel("$C_r$ ($\mathrm{\AA}^2$/ps$^2$)", color='r')
axright3.set_ylim((-.8,2.5))
axright3.set_yticks([0,1,2])
