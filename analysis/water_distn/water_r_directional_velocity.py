...
avgWaterVelocity = np.sqrt(watervr**2 + watervrtheta**2 + watervz**2)
ax1.plot(bins[:-1], avgWaterVelocity[:-1]/10., '-k', label = 'v(water)')
ax1.plot(bins[:-1], watervr[:-1]/10., '-r', label = '$v_r$(water)')
ax1.plot(bins[:-1], watervrtheta[:-1]/10., '-g', label = '$v_{r\\theta}$(water)')
