...
for j in range(10):
    ...
    msd_x += seq_x/float(seqnum)
    msd_y += seq_y/float(seqnum)
    msd_z += seq_z/float(seqnum)
    vacf_x += seq_vx/float(seqnum)
    vacf_y += seq_vy/float(seqnum)
    vacf_z += seq_vz/float(seqnum)
