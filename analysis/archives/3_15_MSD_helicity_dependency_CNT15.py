...
systems = ('CNT15a_int', 'CNT15z_int', 'graphene',\
           'CNT15a_ext', 'CNT15z_ext')
legends = ('CNT15a$_\\mathrm{int}$', 'CNT15z$_\\mathrm{int}$', 'Graphene',\
           'CNT15a$_\\mathrm{ext}$', 'CNT15z$_\\mathrm{ext}$')
cmap_list = (0.8,0.8,0.5,0.2,0.2)
linestyle = ('-', '--', '-', '-', '--', '-')
...
plt.savefig('../images/3_15_MSD_helicity_dependency_CNT15.png', \
