...
systems = ('CNT10a_int', 'CNT10z_int', 'graphene',\
           'CNT10a_ext', 'CNT10z_ext')
legends = ('CNT10a$_\\mathrm{int}$', 'CNT10z$_\\mathrm{int}$', 'Graphene',\
           'CNT10a$_\\mathrm{ext}$', 'CNT10z$_\\mathrm{ext}$')
cmap_list = (0.99,0.99,0.5,0.0,0.0)
linestyle = ('-', '--', '-', '-', '--', '-')
...
plt.savefig('../images/3_10_MSD_helicity_dependency_CNT10.png', \
