...
systems = ('CNT10a_ext', 'CNT10z_ext', 'graphene40',\
           'CNT10a_int', 'CNT10z_int')
legends = ('CNT10a_ext', 'CNT10z_ext', 'Graphene',\
           'CNT10a_int', 'CNT10z_int')
cmap_list = (0,0,0.5,0.99,0.99)
linestyle = ('-', '--', '-', '-', '--', '-')
...
plt.savefig('../images/203_10_Adatom_helicity_dependency_CNT10.png', \
