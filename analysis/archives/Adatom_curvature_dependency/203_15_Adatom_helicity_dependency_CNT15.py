...
systems = ('CNT15a_ext', 'CNT15z_ext', 'graphene40',\
           'CNT15a_int', 'CNT15z_int')
legends = ('CNT15a_ext', 'CNT15z_ext', 'Graphene',\
           'CNT15a_int', 'CNT15z_int')
cmap_list = (0.2,0.2,0.5,0.8,0.8)
linestyle = ('-', '--', '-', '-', '--', '-')
...
plt.savefig('../images/203_15_Adatom_helicity_dependency_CNT15.png', \
