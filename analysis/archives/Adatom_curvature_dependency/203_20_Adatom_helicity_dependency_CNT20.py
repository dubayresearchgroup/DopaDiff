...
systems = ('CNT20a_ext', 'CNT20z_ext', 'graphene40',\
           'CNT20a_int', 'CNT20z_int')
legends = ('CNT20a_ext', 'CNT20z_ext', 'Graphene',\
           'CNT20a_int', 'CNT20z_int')
cmap_list = (0.35,0.35,0.5,0.65,0.65)
linestyle = ('-', '--', '-', '-', '--', '-')
...
for i in range(len(systems)):
    filename = '../Adatom/' + systems[i] + '/nvt/msd_vacf.out'
...
plt.savefig('../images/203_20_Adatom_helicity_dependency_CNT20.png', \
