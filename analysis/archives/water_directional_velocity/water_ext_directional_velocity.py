...
for i in range(10):
    print(i)
    filename = '/Volumes/Backup/DopaDiff/DA/CNT10a_ext/nvt/' + str(i) + '/waterVelocity.txt'
    ...
    df = pd.read_csv(filename, delimiter = ' ', \
                     ...
                     names = ['x', 'y', 'z', \
                              ...
                              'mass', 'None'], \
                     header = None)
    with open('/Users/jiaqz/Desktop/DA/CNT10a_ext/nvt/' + str(i) + '/after_nvt.data', "r") as f:
...
plt.savefig('water_ext_directional_velocity.png', dpi=300, bbox_inches='tight')