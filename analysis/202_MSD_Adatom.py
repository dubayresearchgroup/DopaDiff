...
for chirality in chiralities:
    ...
    systems = ('CNT10' + chirality + '_int', 
               'graphene', 
               'CNT10' + chirality + '_ext')
    legends = ('CNT10' + chirality + '$_\\mathrm{int}$', 
               'Graphene', 
               'CNT10' + chirality + '$_\\mathrm{ext}$')
    ...
    for i in range(len(systems)):
        filename = '/Users/jiaqz/Desktop/Adatom/' + systems[i] + '/nvt/msd_vacf_10.out'
    ...
    ax3.legend(legends, loc='center left', frameon=True, bbox_to_anchor=(1.02, 1))

    plt.savefig('/Users/jiaqz/Desktop/images/202_MSD_Adatom_' + chirality + '.png', \
