...
for i in range(10):
    ...
    z[0,i*500001:(i+1)*500001] = np.abs((temp_z % lz) - electrode_z)
    z[1,i*500001:(i+1)*500001] = np.abs((temp_amine_z % lz) - electrode_z)
    z[2,i*500001:(i+1)*500001] = np.abs((temp_ring_z % lz) - electrode_z)
    z[3,i*500001:(i+1)*500001] = np.abs((temp_quinone_z % lz) - electrode_z)
